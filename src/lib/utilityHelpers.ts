...
export const utilityDefinitions: HelperSchema[] = [
  {
    ...
    definition: 'Outputs cacheable and cache-busting relative URLs to various asset',
...
{{/contentFor}}`,
...

  {
    ...
    snippet: null,
    usage: '{{{block "section"}}} and {{#contentFor "section"}}',
    definition: '`{{#contentFor}}` is a helper for adding to a block placeholder.',
    example: `<!-- default.hbs -->
<body>
    {{{block "scripts"}}}
</body>
...
{{/contentFor}}`,
...

  {
    ...
    usage: '{{!< default}}',
    definition:
      "`{{!< default}}` tells Ghost to insert the template's contents into the `default.hbs` template.",
    example: '{{!< default}}',
...
<span class="hidden">Twitter</span>
  ...
  },
  {
    ...
    snippet: null,
    usage: '{{ghost_foot}}',
    definition: 'Outputs anything added to `Code Injection` at the global or page level.',
    example: `<body>
  <!-- ... -->
  {{ghost_foot}}
</body>`,
...
{{/post}}`,
...

  {
    ...
    type: HelperTypes['utility'],
    snippet: null,
    usage: '{{#next_post}}{{title}}{{/next_post}}',
    definition:
...
{{/post}}`,
...

  {
    ...
    snippet: null,
    usage: '{{reading_time}}',
    definition: '`{{reading_time}}` renders the estimated reading time for a post.',
