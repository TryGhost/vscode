...
export const attributes: HelperSchema[] = [
...

  {
    ...
    definition:
      "Configure the card CSS and JSS Ghost includes in `package.json`",
...
{{/get}}`,
...

  {
    ...
    snippet: null,
    usage: "{{@site.icon}}",
    definition: "The publication icon from `Design` &rarr; `Brand` settings.",
...

  {
    ...
    snippet: null,
    usage: "{{@site.logo}}",
    definition: "The publication logo from `Design` &rarr; `Brand` settings.",
...

  {
    ...
    definition:
      "The publication cover image from `Design` &rarr; `Brand` settings.",
